...
import Reactable from '../src/reactable'

const ReactTestUtils = React.addons.TestUtils
const expect = chai.expect

const ReactableTestUtils = {
  ...
  expectRowClass(rowIndex, className) {
  ...
  expectRowText(rowIndex, textArray) {
...
describe('Reactable', () => {
  describe('with null children', () => {
    ...
    it('renders the table', () => expect($('table#table.table')).to.exist)
  })

  describe('directly passing a data array', () => {
    before(() => {
      ReactDOM.render(
        <Reactable.Table
          className='table'
    ...
    it('renders the column headers in the table', () => {
      var headers = []
    ...
    it('renders the first row with the correct data', () => {
      ReactableTestUtils.expectRowText(0, ['Griffin Smith', '18', ''])
    })

    it('renders the second row with the correct data', () => {
      ReactableTestUtils.expectRowText(1, ['Lee Salminen', '23', ''])
    })

    it('renders the third row with the correct data', () => {
  ...
  describe('directly passing a data array with non-string data', function () {
    before(function () {
      ReactDOM.render(
        <Reactable.Table className='table' id='table' data={[
          { Name: 'Griffin Smith', Age: 18},
          { Age: 23, Name: { toString() { return 'Lee Salminen' } } },
